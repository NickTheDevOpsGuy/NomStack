...
import type { Sense } from '@/types/dictionary.types';
...
export default function App() {
  ...
  const [safeMode, setSafeMode] = useLocalStorage<boolean>('safe-mode', true);
            ...
            {filteredData.senses?.length ? (
              ...
              <div className='rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900'>
                <p className='text-sm text-zinc-700 dark:text-zinc-300'>
                  All definitions were hidden by <strong>Safe mode</strong>. Try
                  turning it off to see more results.
                </p>
              </div>
            )}
          </>
